export const IconCopy = () => {
  return (
    <svg
      className="workbench__icon-copy"
      focusable="false"
...
export const IconGithub = ({ theme }: { theme: string }) => {
  return (
    <svg
...
export const MoonIcon = ({ theme }: { theme: string }) => {
  return (
    <svg
      width="15"
      height="15"
...
export const SunIcon = ({ theme }: { theme: string }) => {
  return (
    <svg
      width="15"
      height="15"
